    ...
    <>
      <li>
        <NavLink className={({ isActive }) =>
          isActive
            ? "text-blue-700 underline font-bold  hover:bg-blue-200 hover:text-black "
            : "text-gray-600 hover:bg-blue-200 hover:text-black dark:text-blue-600 font-bold"
        }
          to="/" >
          Home
        </NavLink>
      ...
      <li>
        ...
        <li><NavLink className={({ isActive }) =>
          ...
          to="/my-booking-tutors">My Booking</NavLink></li>
        </>
      }
    </>
  );
...
<div className="navbar sticky top-0 w-full z-50 bg-[#fefae0] dark:bg-gray-900 dark:text-white shadow-sm lg:pl-20 lg:pr-20">
  <div className="navbar-start">
    ...
    <a className="text-xl font-bold cursor-pointer text-blue-700">Tutoria</a>
  </div>
